...
this.on("READ", Risks, async (req, next) => {
 /*
   ...
   As the business partner does not reside in the CAP database but in a remote system instead, a direct expand is not possible. 
   The data needs to be retrieved from the SAP S/4HANA Cloud system.
 */
